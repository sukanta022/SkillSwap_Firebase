    ...
    return (
        <div className='w-11/12 mx-auto py-15'>
            ...
            <div className='flex flex-col gap-2 md:flex-row justify-center md:justify-between items-center'>
                ...
                <Link onClick={() => window.scrollTo(0, 0)} to={'/skills'} className='text-xl text-[#0D9488] flex gap-1 items-center hover:underline'>View all categories <MdArrowForwardIos /></Link>
            </div>
